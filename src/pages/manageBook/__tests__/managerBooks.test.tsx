...
import { addBookOptimistic, BooksReducer, BooksState, updateBookOptimistic } from '@/store/books';
...
describe('<ManageBook />', () => {
    ...
    it('should show a toast whenever adding a duplicate book', async () => {
        ...
        fireEvent.change(wrapper.getByTestId('title-input'), { target: { value: testBooks[0].title } });
        fireEvent.change(wrapper.getByTestId('author-input'), { target: { value: testBooks[0].author } });
