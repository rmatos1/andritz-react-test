...
export const BookList: React.FC<BookListProps> = ({ books }) => {
  ...
  return (
    <>
      {isModalVisible && (
        <DeleteBookModal book={selectedBook} onCloseModal={onCloseModal} />
      )}
      ...
      <section>
        {
          <>
            {books.length ? (
              ...
              <p className={globalStyles.text} data-testid="no-books-result">
                There's no book that match with this search criteria
              </p>
            )}
          </>
        }
